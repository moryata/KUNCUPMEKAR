...
get_header(); ?>
    <section class="error-404 not-found os-animation">
        ...
        <div class="page-content os-animation" data-os-animation="fadeInUp">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/uploads/error404.png" alt="<?php esc_attr_e( 'Oops! That page can not be found.', 'kids-education' ); ?>">
         ...
         <?php get_search_form(); ?>
          <a href="<?php echo esc_url( home_url('/' ) ); ?>" class="btn btn-blue"><?php esc_html_e( 'Back to Homepage!', 'kids-education' ); ?></a>
        </div><!-- .page-content -->
     </section>
