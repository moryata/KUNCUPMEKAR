...
function tp_education_archive_event_content() {
	?>
			...
			<div class="course-contents">
				<div class="course-header-contents">
					...
					<div class="categories">
						...
						<?php 
						// get all terms
						tp_education_get_terms( 'tp-event-category' );
						?>
					</div><!-- .categories -->
					<div class="tags">
						...
						<?php 
						// get all terms
						tp_education_get_terms( 'tp-event-tag' );
						?>
					</div><!-- .tags -->
...
add_action( 'tp_education_archive_event_content_action', 'tp_education_archive_event_content', 10 );
