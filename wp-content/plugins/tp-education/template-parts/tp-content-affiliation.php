...
function tp_education_archive_affiliation_content() {
	?>
			...
			<div class="course-contents">
				<div class="course-header-contents">
					...
					<div class="categories">
						...
						<?php 
						// get all terms
						tp_education_get_terms( 'tp-affiliation-category' );
						?>
					</div><!-- .categories -->
					<div class="tags">
						...
						<?php 
						// get all terms
						tp_education_get_terms( 'tp-affiliation-tag' );
						?>
					</div><!-- .tags -->
...
add_action( 'tp_education_archive_affiliation_content_action', 'tp_education_archive_affiliation_content', 10 );
