<?php
/**
 * Affiliation Search Tab Form.
 *
 * @package TP Education
 * @since 1.0
 */

function tp_education_search_affiliation_form() {
	?>
			...
			<form role="search" action="<?php echo esc_url( site_url('/') ); ?>" method="get" id="searchform">
				...
				<div class="search two-columns">
					<div class="column-wrapper">
		                ...
		                $args = array(
		                    'option_none_value'  => __( 'Affiliation Category', 'tp-education' ),
		                    'hide_empty'         => 0,              
		                    'selected'           => 1,
		                    'hierarchical'       => 1,
		                    'name'               => 'tp_term',
						...
						<input type="hidden" name="post_type" value="tp-affiliation" />
					</div><!-- .column-wrapper -->
					<div class="column-wrapper">
...
add_action( 'tp_education_search_affiliation_form_action', 'tp_education_search_affiliation_form', 10 );
